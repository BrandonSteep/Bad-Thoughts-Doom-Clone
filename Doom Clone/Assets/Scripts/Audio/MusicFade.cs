...
public class MusicFade : MonoBehaviour
{
    ...
    public void FadeIn(){
        StartCoroutine(PerformFade(0f, 1f, fadeInEvent, longFadeDuration));
    }

    public void FadeOut(){
        StartCoroutine(PerformFade(1f, 0f, fadeOutEvent, longFadeDuration));
    }

    public void FadeOutQuick(){
        StartCoroutine(PerformFade(1f, 0f, fadeOutEvent, shortFadeDuration));
    }
