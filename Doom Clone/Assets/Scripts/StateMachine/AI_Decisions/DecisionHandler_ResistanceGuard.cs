using UnityEngine;
public class DecisionHandler_ResistanceGuard : IDecisionHandler
{
    // State References //
    ...
    private State stateStrafeLeft = new State_StrafeLeft_RootMotion();
    private State stateStrafeRight = new State_StrafeRight_RootMotion();
